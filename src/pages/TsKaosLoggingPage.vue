<template>
  <q-layout view="hHh lpR fFf">
    <q-page-container>
      <div class="q-pa-md">
        <h4>TypeScript AOP Logging with Kaop library</h4>
...
import TsKaosCartManager from 'src/models/TsKaosCartManager';

const cartManager = reactive(new TsKaosCartManager());
