<template>
  <q-layout view="hHh lpR fFf">
    <q-page-container>
      <div class="q-pa-md">
        <h4>Traditional Cart with Direct Logging</h4>
...
import TraditionalCartManager from 'src/models/TraditionalCartManager';

const cartManager = reactive(new TraditionalCartManager());
